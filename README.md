...
Neste projeto foi desenvolvidas queries mongoDB para Executar buscas complexas no banco de dados, usando operadores de aggregation para fazer uma pipeline.
